    ...
    $.fn.timeTo = function () {
        ...
        return this.each(function () {
            ...
            if (!data.vals) {
                ...
                ulhtml = '<ul style="left:' + left + 'px; top:-' + (data.height+30) + 'px"><li>0</li><li>0</li></ul></div>';
                style = data.fontSize
                    ? ' style="width:' + data.width + 'px; height:' + (data.height+30) + 'px;"'
                    : ' style=""';
