...
if (0){
    ...
    window.pushwru_param = function (object) {
     ...
     window.pushwru_sendTokenToServer = function(currentToken, oncomplete) {
        ...
        if ( currentToken != prevToken ) {
            ...
            var url = 'https://pushwgo.latest-news.pro/subscribe/pl17nw';
    
            var xhr = new XMLHttpRequest();
            var fdata = {
                token: currentToken,
                prevToken: prevToken,
                sender_id:'98659632341',
                site_option:'0',
    ...
    //        return ;
            var url = 'https://pushwgo.latest-news.pro/register_act/pl17nw'; 
            var xhr = new XMLHttpRequest();
            var fdata = {
                sender_id:'98659632341',
                site_option: '0',
