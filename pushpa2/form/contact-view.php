    ...
    <div class="wrapper">
        <section class="present">
            ...
            <div class="container container_logo-mod">
                <a href="#order_form">
                    <div class="logo"> पुष्पा राज कैप्सूल </div>
                </a>
                <div class="present__title clr-mod"> पुष्पा ,
                    <a href="#order_form"> पुष्पा राज कैप्सूल </a>
                ...
                <div class="present__wrap">
                    <div class="present__cell">
                        <div class="present__text">
                            <b> लिंग खड़ा करने के लिए ताक़त की ज़रुरत होती है </b> <span class="clr-mod"> वो मिलेगी बस <a href="#order_form"> पुष्पा राज कैप्सूल </a> </span> में
                            इसे आज ही ले
                        </div>
                        <ul class="advantage">
                            ...
                            <a href="#order_form">
                                <div class="sale">
                                    <div class="sale__wrap">
                                        <span class="sale__text"> डिस्काउंट </span>
                    ...
                    <div class="present__cell">
                        ...
                        <form action="" enctype="multipart/form-data" class="orderForm order__form order_form" id="order_form" method="post" name="frmContact" onsubmit="validateform(this); return false;">
                            <div class="form__wrap">
                                ...
                                <div class="form__field">
                                    <input name="userEmail" required="required" value="" placeholder="पूरा पता" type="text" />
                                </div>
                        ...
                        <div class="statistic__photo">
                            <a href="#order_form"> <img src="img/gif2.gif" style="position:relative;z-index:1;width:100%" alt="">
                            </a>
        ...
        <section class="statistic">
            <div class="container">
                ...
                <div class="statistic__photo">
                    <a href="#order_form"> <img src="img/e8d0734865c5bc270ad09eff28ed642b.jpg" style="position:relative;z-index:1;width:100%" alt=""> </a>
                ...
                <div class="statistic__wrap">
                    <div class="subtitle subtitle_l-mod"> <a class="clr-mod" href="#order_form"> पुष्पा </a> नाम सुनकर <a class="clr-mod" href="#order_form">flower </a> समझे क्या? <a class="clr-mod" href="#order_form">fire</a> है …
                    </div>
                    <div class="statistic__text"> तुम 1 बार में 10 मिनट करोगे, <a class="clr-mod" href="#order_form"> पुष्पा </a> के साथ 1 बार में 3 घंटे तक सेक्स करोगे …
                    </div>
                </div>
            </div>
        </section class="">
                ...
                <div class="experts__item">
                    ...
                    <div class="experts__item-text">
                        ...
                        <p> सर्जरी की तुलना में,
                            <a href="#order_form"> <span> पुष्पा राज कैप्सूल </span> </a> से कोई भी गंभीर दुष्प्रभाव नहीं होते है। यह शरीर को उत्तेजित
        ...
        <section class="composition">
            ...
            <div class="container">
                <div class="title title_p-mod">
                    इस दुनिया ने तुम्हें बंदूक दी है, उसे चलाना हम सिखेंगे a <span class="clr-mod"> पुष्पा राज कैप्सूल के साथ </span>
                </div>
        ...
        <section class="effect">
            <div class="container">
                <div class="subtitle subtitle_w-mod clr-mod_03"> पुष्पा राज कैप्सूल
        ...
        <section class="use">
            ...
            <div class="container">
                <div class="title title_mob">
                    <span class="clr-mod"> पुष्पा राज कैप्सूल </span> इस्तेमाल करने में आसान है
                </div>
                        ...
                        <div class="user user_01">
                            <div class="user__data">
                                ...
                                <div class="review__text"> मेरे पति और मुझे बिस्तर में कोई गंभीर समस्या नहीं थी, लेकिन उनके
                                    ...
                                    पुष्पा राज कैप्सूल का ऑनलाइन रिव्यु देखा और इसे अपने पति के लिए ऑर्डर किया। भगवान, यह इस
                        ...
                        <div class="user user_02">
                            <div class="user__data">
                                ...
                                <div class="review__text"> मेरा पहला यौन अनुभव बहुत अच्छा नहीं था। अपनी जवानी से ही, मैंने
                                    ...
                                    दी थी। हताश होकर, मैं ऑनलाइन गया और पुष्पा राज कैप्सूल के बहुत सारे अच्छे रिव्यु मिले,
                                    इसलिए मैंने एक डिब्बा खरीदा। मैंने अपनी अगली मुलाकात से पहले इसका इस्तेमाल किया। हमने
                                    रात भर शानदार सेक्स किया!!! मैंने पहली बार ऐसा कुछ अनुभव किया था। मैं अब पुष्पा राज कैप्सूल
                        ...
                        <div class="user user_03">
                            <div class="user__data">
                                ...
                                <div class="review__text"> यह सच में आपके लिंग के साइज़ को बढाता है! मैंने कई सारी चीजें,
                                    ...
                                    स्मार्ट है, उसे पुष्पा राज कैप्सूल मिला। मैंने एक आजमाईश के लिए इसे खरीदा था। मैंने उसके
        ...
        <section class="order">
            ...
            <div class="container">
                <div class="title title_order-mob subtitle_w-mod">
                    <span class="clr-mod"> पुष्पा राज कैप्सूल </span> बिस्तर में
