            ...
            <div class="wrapper">
                    ...
                    <div class="clearfix">
                        <div class="header__block header__block--left clearfix">
                            <div class="header__txt-wrapper">
                                <p class="header__txt">Kam-Ratan के साथ, आपका लिंग आपकी कल्पना से भी अधिक बड़ा हो सकता है
                                </p>
                            </div>
                ...
                <div class="header__bottom-block clearfix">
                    ...
                    <div class="header__doc-txt-wrapper">
                        <p class="header__doc-txt">वैज्ञानिकों द्वारा किए गए आधुनिक विकास घर पर लिंग का आकार बढ़ाने की सुविधा देते हैं। अब किसी तरह की सर्जरी या हानिकारक उपचार की ज़रूरत नहीं। <span>Kam-Ratan</span> का फॉर्मूला स्वास्थ्य के बिल्कुल अनुकूल है। </p>
        ...
        <main class="main">
            <section class="advantages">
                <div class="advantages__txt-wrapper">
                    <p class="advantages__txt wrapper">लिंग में गारंटी से वृद्धि के लिए Kam-Ratan का व्यवस्थित ढंग से उपयोग ज़रूरी है।</p>
                </div>
                <div class="wrapper">
                    <h2 class="advantages__title">Kam-Ratan के फायदे</h2>
          ...
          -->
            ...
            <section class="promo">
                <div class="wrapper clearfix">
                    ...
                    <div class="promo__right-block">
                        <p class="promo__txt">कामोन्माद के पारम्परिक विचार के बारे में भूल जाइए। Kam-Ratan के साथ अद्भुत आनंद का अनुभव होगा।</p>
            ...
            <section class="info">
                <div class="wrapper">
                    ...
                    <p class="info__txt info__txt--title lightblue">Kam-Ratan</p>
            ...
            <section class="order">
                <div class="wrapper">
                    <div class="order__card clearfix">
                        <h2 class="order__title">Kam-Ratan </h2>
