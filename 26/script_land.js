var Attention = function() {
    ...
    function t(e, t) {
        function s(e) {
            if (e.matches) r.prepend(i()), r.prepend(a()), r.append(a());
            else
                for (var t = document.querySelectorAll(".blockRedLine3103 .blockRedLine3103__image"), s = 0; s < t.length; s++) t[s].remove()
        }
    ...
    function a() {
        ...
        e.classList.add("blockRedLine3103__image");
        for (var t = ["0px", "20px", "10px"], a = ["10px", "10px", "0px"], i = 0; i < 3; i++) {
            var s = document.createElement("div");
            s.style.cssText = "width: 65px; height: 5px; border-radius: 2px; background: rgba(255, 255, 255, 0.3); margin-top: 0; margin-right: 0; margin-bottom: " + a[i] + "; margin-left: " + t[i] + "; box-sizing: border-box;", e.append(s)
        }
        return e.style.cssText = "flex-shrink: 0; box-sizing: border-box; padding: 0; margin: 0;", e
    }
