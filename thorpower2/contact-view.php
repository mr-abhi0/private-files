        ...
        <header class="header">
            <div class="wrapper">
                <div class="header__card clearfix">
                    <h1 class="header__title">The Thor Power</h1>
                    <div class="clearfix">
                        <div class="header__block header__block--left clearfix">
                            <div class="header__txt-wrapper">
                                <p class="header__txt">The Thor Power के साथ, आपका लिंग आपकी कल्पना से भी अधिक बड़ा हो
                                    सकता है
                                </p>
                            </div>
                        ...
                        <div class="header__block header__block--right">
                            <p class="header__block-title">क्या आप जानते हैं कि किसी भी पुरुष का लिंग 20 सेमी या अधिक
                                बड़ा हो सकता है?
                            </p>
                ...
                <div class="header__bottom-block clearfix">
                    ...
                    <div class="header__doc-txt-wrapper">
                        <p class="header__doc-txt">वैज्ञानिकों द्वारा किए गए आधुनिक विकास घर पर लिंग का आकार बढ़ाने की
                            सुविधा देते हैं। अब किसी तरह की सर्जरी या हानिकारक उपचार की ज़रूरत नहीं। <span>The Thor
                                Power</span> का फॉर्मूला स्वास्थ्य के बिल्कुल अनुकूल है। </p>
                        <p class="header__doc-txt">आपका लिंग केवल दो सप्ताह में 2,5 -3 सेमी बढ़ जाएगा, कामोन्माद बहुत
                            अधिक तीव्र हो जाएगा और संभोग की अवधि 3 घंटे तक बढ़ जाएगी।</p>
                    </div>
                </div>
            </div>
        </header>
        <main class="main">
            <section class="advantages">
                <div class="advantages__txt-wrapper">
                    <p class="advantages__txt wrapper">लिंग में गारंटी से वृद्धि के लिए The Thor Power का व्यवस्थित ढंग
                        से उपयोग ज़रूरी है।</p>
                </div>
                <div class="wrapper">
                    <h2 class="advantages__title">The Thor Power के फायदे</h2>
            ...
            <section class="promo">
                <div class="wrapper clearfix">
                    ...
                    <div class="promo__right-block">
                        <p class="promo__txt">कामोन्माद के पारम्परिक विचार के बारे में भूल जाइए। The Thor Power के साथ
                            अद्भुत आनंद का अनुभव होगा।</p>
            ...
            <section class="info">
                <div class="wrapper">
                    ...
                    <p class="info__txt info__txt--title lightblue">The Thor Power</p>
            ...
            <section class="order">
                <div class="wrapper">
                    <div class="order__card clearfix">
                        <h2 class="order__title">The Thor Power </h2>
                        ...
                        <div class="order__block-wrapper clearfix">
                            ...
                            <form action="" enctype="multipart/form-data" id="OrderForm" class="order__form form" method="POST">
                                ...
                                <div class="form__btn-wrapper">
                                    <div class="va">
                                        <button type="submit" value=" अभी ऑर्डर करें " name="send" class="button__text js_submit form__btn btn order__btn anchor">अभी ऑर्डर
                                            कीजिए
                                        </button>
                                    </div>
                                </div>
