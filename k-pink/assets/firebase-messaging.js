! function(e, t) { "object" == typeof exports && "undefined" != typeof module ? t(require("@firebase/app")) : "function" == typeof define && define.amd ? define(["@firebase/app"], t) : t((e = e || self).firebase) }(this, function(L) {
    "use strict";
    try {
        (function() {
            ...
            function v(n, r) {
                var o, i, s, e, a = { label: 0, sent: function() { if (1 & s[0]) throw s[1]; return s[1] }, trys: [], ops: [] };
            ...
            var l = function(r) {
                    function o(e, t) { var n = r.call(this, t) || this; return n.code = e, n.name = "FirebaseError", Object.setPrototypeOf(n, o.prototype), Error.captureStackTrace && Error.captureStackTrace(n, a.prototype.create), n }
                    return i(o, r), o
                }(Error),
                a = function() {
                    function e(e, t, n) { this.service = e, this.serviceName = t, this.errors = n }
                    return e.prototype.create = function(e) { for (var t = [], n = 1; n < arguments.length; n++) t[n - 1] = arguments[n]; for (var r, o = t[0] || {}, i = this.service + "/" + e, s = this.errors[e], a = s ? (r = o, s.replace(p, function(e, t) { var n = r[t]; return null != n ? n.toString() : "<" + t + "?>" })) : "Error", c = this.serviceName + ": " + a + " (" + i + ").", u = new l(i, c), d = 0, f = Object.keys(o); d < f.length; d++) { var h = f[d]; "_" !== h.slice(-1) && (h in u && console.warn('Overwriting FirebaseError base field "' + h + '" can cause unexpected behavior.'), u[h] = o[h]) } return u }, e
                }();
            var p = /\{\$([^}]+)}/g;

            function o(e, t) { var n = new c(e, t); return n.subscribe.bind(n) }
            var e, c = function() {
                function e(e, t) {
                    var n = this;
                ...
                return e.prototype.next = function(t) { this.forEachObserver(function(e) { e.next(t) }) }, e.prototype.error = function(t) { this.forEachObserver(function(e) { e.error(t) }), this.close(t) }, e.prototype.complete = function() { this.forEachObserver(function(e) { e.complete() }), this.close() }, e.prototype.subscribe = function(e, t, n) {
                    var r, o = this;
                    if (void 0 === e && void 0 === t && void 0 === n) throw new Error("Missing Observer.");
                    void 0 === (r = function(e, t) { if ("object" != typeof e || null === e) return !1; for (var n = 0, r = t; n < r.length; n++) { var o = r[n]; if (o in e && "function" == typeof e[o]) return !0 } return !1 }(e, ["next", "error", "complete"]) ? e : { next: e, error: t, complete: n }).next && (r.next = u), void 0 === r.error && (r.error = u), void 0 === r.complete && (r.complete = u);
                    var i = this.unsubscribeOne.bind(this, this.observers.length);
                    return this.finalized && this.task.then(function() { try { o.finalError ? r.error(o.finalError) : r.complete() } catch (e) {} }), this.observers.push(r), i
            ...
            function S(e) { return T(e).replace(/=/g, "").replace(/\+/g, "-").replace(/\//g, "_") }(t = d || (d = {})).TYPE_OF_MSG = "firebase-messaging-msg-type", t.DATA = "firebase-messaging-msg-data", (h = f || (f = {})).PUSH_MSG_RECEIVED = "push-msg-received", h.NOTIFICATION_CLICKED = "notification-clicked";
            var _ = function() {
                function e() {}
                return e.prototype.getToken = function(d, f, h) {
                    return b(this, void 0, void 0, function() {
                        ...
                        return v(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    t = S(f.getKey("p256dh")), n = S(f.getKey("auth")), r = "authorized_entity=" + d + "&endpoint=" + f.endpoint + "&encryption_key=" + t + "&encryption_auth=" + n, k(h.buffer, w.buffer) || (o = S(h), r += "&application_pub_key=" + o), (i = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), s = { method: "POST", headers: i, body: r }, e.label = 1;
                                case 1:
                                ...
                                case 3:
                                    return a = e.sent(), [3, 5];
                                case 4:
                                    throw c = e.sent(), y.create("token-subscribe-failed", { errorInfo: c });
                                case 5:
                                    if (a.error) throw u = a.error.message, y.create("token-subscribe-failed", { errorInfo: u });
                    ...
                    return b(this, void 0, void 0, function() {
                        ...
                        return v(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    t = S(l.getKey("p256dh")), n = S(l.getKey("auth")), r = "push_set=" + h + "&token=" + f + "&authorized_entity=" + d + "&endpoint=" + l.endpoint + "&encryption_key=" + t + "&encryption_auth=" + n, k(p.buffer, w.buffer) || (o = S(p), r += "&application_pub_key=" + o), (i = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), s = { method: "POST", headers: i, body: r }, e.label = 1;
                                case 1:
                                    return e.trys.push([1, 4, , 5]), [4, fetch(m + "/fcm/connect/subscribe", s)];
                                case 2:
                                    return [4, e.sent().json()];
                                case 3:
                                    return a = e.sent(), [3, 5];
                                case 4:
                                    throw c = e.sent(), y.create("token-update-failed", { errorInfo: c });
                                case 5:
                                    if (a.error) throw u = a.error.message, y.create("token-update-failed", { errorInfo: u });
                    ...
                    return b(this, void 0, void 0, function() {
                        ...
                        return v(this, function(e) {
                            switch (e.label) {
                                case 0:
                                    t = "authorized_entity=" + a + "&token=" + c + "&pushSet=" + u, (n = new Headers).append("Content-Type", "application/x-www-form-urlencoded"), r = { method: "POST", headers: n, body: t }, e.label = 1;
                                case 1:
                                    return e.trys.push([1, 4, , 5]), [4, fetch(m + "/fcm/connect/unsubscribe", r)];
                                case 2:
                                    return [4, e.sent().json()];
                                case 3:
                                    if ((o = e.sent()).error) throw i = o.error.message, y.create("token-unsubscribe-failed", { errorInfo: i });
                                    return [3, 5];
                                case 4:
                                    throw s = e.sent(), y.create("token-unsubscribe-failed", { errorInfo: s });
                                case 5:
                                    return [2]
                            }
                        })
            ...
            function P(e) { for (var t = (e + "=".repeat((4 - e.length % 4) % 4)).replace(/\-/g, "+").replace(/_/g, "/"), n = atob(t), r = new Uint8Array(n.length), o = 0; o < n.length; ++o) r[o] = n.charCodeAt(o); return r }
            var M = "undefined",
                    ...
                    ! function(n) {
                        if (n.objectStoreNames.contains(D)) {
                            var e = n.transaction(D).objectStore(D),
                                r = new _,
                                o = e.openCursor();
                            o.onerror = function(e) { console.warn("Unable to cleanup old IDB.", e) }, o.onsuccess = function() {
                                var e = o.result;
                                if (e) {
                                    var t = e.value;
            ...
            var C = function() {
                function e() { this.dbPromise = null }
                return e.prototype.get = function(t) { return this.createTransaction(function(e) { return e.get(t) }) }, e.prototype.getIndex = function(t, n) { return this.createTransaction(function(e) { return e.index(t).get(n) }) }, e.prototype.put = function(t) { return this.createTransaction(function(e) { return e.put(t) }, "readwrite") }, e.prototype.delete = function(t) { return this.createTransaction(function(e) { return e.delete(t) }, "readwrite") }, e.prototype.closeDatabase = function() {
                    return b(this, void 0, void 0, function() {
                        return v(this, function(e) {
                            switch (e.label) {
                                case 0:
                    ...
                    return void 0 === a && (a = "readonly"), b(this, void 0, void 0, function() {
                        ...
                        return v(this, function(e) {
                            switch (e.label) {
                                ...
                                case 2:
                                    return i = e.sent(), [2, new Promise(function(e, t) { r.oncomplete = function() { e(i) }, r.onerror = function() { t(r.error) } })]
                            }
                            var n
                        })
                    })
                    ...
                    return this.dbPromise || (this.dbPromise = new Promise(function(e, t) {
                        ...
                        n.onsuccess = function() { e(n.result) }, n.onerror = function() { r.dbPromise = null, t(n.error) }, n.onupgradeneeded = function(e) { return r.onDbUpgrade(n, e) }
                    })), this.dbPromise
                }, e
            }();
            var O = function(t) {
                function e() { var e = null !== t && t.apply(this, arguments) || this; return e.dbName = "fcm_token_details_db", e.dbVersion = 3, e.objectStoreName = "fcm_token_object_Store", e }
            ...
            var E = function(t) {
                    ...
                    }, e.prototype.saveVapidDetails = function(n, r) { return b(this, void 0, void 0, function() { var t; return v(this, function(e) { if ("string" != typeof n || 0 === n.length) throw y.create("bad-scope"); if (null === r || 65 !== r.length) throw y.create("bad-vapid-key"); return t = { swScope: n, vapidKey: r }, [2, this.put(t)] }) }) }, e.prototype.deleteVapidDetails = function(n) {
                        return b(this, void 0, void 0, function() {
                            var t;
                            return v(this, function(e) {
                                switch (e.label) {
                ...
                K = function() {
                    function e(e) {
                        ...
                        this.messagingSenderId = e.options[x], this.tokenDetailsModel = new O, this.vapidDetailsModel = new E, this.iidModel = new _, this.app = e, this.INTERNAL = { delete: function() { return t.delete() } }
                    }
                    ...
                    }, e.prototype.getPushSubscription = function(t, n) { return t.pushManager.getSubscription().then(function(e) { return e || t.pushManager.subscribe({ userVisibleOnly: !0, applicationServerKey: n }) }) }, e.prototype.requestPermission = function() { throw y.create("only-available-in-window") }, e.prototype.useServiceWorker = function(e) { throw y.create("only-available-in-window") }, e.prototype.usePublicVapidKey = function(e) { throw y.create("only-available-in-window") }, e.prototype.onMessage = function(e, t, n) { throw y.create("only-available-in-window") }, e.prototype.onTokenRefresh = function(e, t, n) { throw y.create("only-available-in-window") }, e.prototype.setBackgroundMessageHandler = function(e) { throw y.create("only-available-in-sw") }, e.prototype.delete = function() {
                        return b(this, void 0, void 0, function() {
                            return v(this, function(e) {
                                switch (e.label) {
                                    case 0:
                    ...
                    }, e.prototype.getNotificationPermission_ = function() { return Notification.permission }, e.prototype.getTokenDetailsModel = function() { return this.tokenDetailsModel }, e.prototype.getVapidDetailsModel = function() { return this.vapidDetailsModel }, e.prototype.getIidModel = function() { return this.iidModel }, e
                }();
            var A = "FCM_MSG",
                V = function(n) {
                    function e(e) { var t = n.call(this, e) || this; return t.bgMessageHandler = null, self.addEventListener("push", function(e) { t.onPush(e) }), self.addEventListener("pushsubscriptionchange", function(e) { t.onSubChange(e) }), self.addEventListener("notificationclick", function(e) { t.onNotificationClick(e) }), t }
                    return i(e, n), e.prototype.onPush = function(e) { e.waitUntil(this.onPush_(e)) }, e.prototype.onSubChange = function(e) { e.waitUntil(this.onSubChange_(e)) }, e.prototype.onNotificationClick = function(e) { e.waitUntil(this.onNotificationClick_(e)) }, e.prototype.onPush_ = function(a) {
                        return b(this, void 0, void 0, function() {
                            var t, n, r, o, i, s;
                            return v(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        if (!a.data) return [2];
                                        try { t = a.data.json() } catch (e) { return [2] }
                            ...
                            return v(this, function(e) {
                                switch (e.label) {
                                    ...
                                    case 4:
                                        r = e.sent(), e.label = 5;
                                    case 5:
                                        return r ? (delete t.notification, delete t.fcmOptions, o = W(f.NOTIFICATION_CLICKED, t), [2, this.attemptToMessageClient_(r, o)]) : [2]
                                }
                            })
                        })
                    }, e.prototype.getNotificationData_ = function(e) { var t; if (e && "object" == typeof e.notification) { var n = s({}, e.notification); return n.data = s({}, e.notification.data, ((t = {})[A] = e, t)), n } }, e.prototype.setBackgroundMessageHandler = function(e) {
                    ...
                    }, e.prototype.attemptToMessageClient_ = function(t, n) { return b(this, void 0, void 0, function() { return v(this, function(e) { if (!t) throw y.create("no-window-client-to-msg"); return t.postMessage(n), [2] }) }) }, e.prototype.hasVisibleClients_ = function() {
                        return b(this, void 0, void 0, function() {
                            return v(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, F()];
                                    case 1:
                                        return [2, e.sent().some(function(e) { return "visible" === e.visibilityState && !e.url.startsWith("chrome-extension://") })]
                                }
                            })
                        })
                            ...
                            return v(this, function(e) {
                                switch (e.label) {
                                    case 0:
                                        return [4, F()];
                                    case 1:
                                        return t = e.sent(), n = W(f.PUSH_MSG_RECEIVED, o), [4, Promise.all(t.map(function(e) { return r.attemptToMessageClient_(e, n) }))];
                                    case 2:
                                        return e.sent(), [2]
                                }
                            })
                        })
                    }, e.prototype.getSWRegistration_ = function() { return b(this, void 0, void 0, function() { return v(this, function(e) { return [2, self.registration] }) }) }, e.prototype.getPublicVapidKey_ = function() {
                        return b(this, void 0, void 0, function() {
                            var t, n;
                            return v(this, function(e) {
                                switch (e.label) {
            ...
            var U, j = function(n) {
                ...
                }, e.prototype.onMessage = function(e, t, n) { return "function" == typeof e ? this.onMessageInternal(e, t, n) : this.onMessageInternal(e) }, e.prototype.onTokenRefresh = function(e, t, n) { return "function" == typeof e ? this.onTokenRefreshInternal(e, t, n) : this.onTokenRefreshInternal(e) }, e.prototype.waitForRegistrationToActivate_ = function(r) {
            ...
            U = { isSupported: R }, L.INTERNAL.registerService("messaging", function(e) { if (!R()) throw y.create("unsupported-browser"); return self && "ServiceWorkerGlobalScope" in self ? new V(e) : new j(e) }, U)
        }).apply(this, arguments)
    } catch (e) { throw console.error(e), new Error("Cannot instantiate firebase-messaging - be sure to load firebase-app.js first.") }
});
